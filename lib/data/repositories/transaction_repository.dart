...
class TransactionRepository {
  ...
  Future<TransactionModel> createBuyOrder(
    String email,
    double amountUsd,
    String cryptoSymbol,
    double cryptoAmount,
  ...
  Future<TransactionModel> createSellOrder(
    String email,
    double amountUsd,
    String cryptoSymbol,
    double cryptoAmount,
  ...
  Future<void> approveTransaction(String txId) async {
    ...
    if (tx['type'] == 'deposit') {
      ...
      if (currentPortfolio != null) {
        ...
        final currentAvgPrice = (currentPortfolio['avg_buy_price'] as num)
            .toDouble();

        final newTotalAmount = currentAmount + cryptoAmount;
        final newAvgPrice =
            ((currentAmount * currentAvgPrice) + amount) / newTotalAmount;
      ...
      if (currentPortfolio == null ||
          (currentPortfolio['amount'] as num).toDouble() < cryptoAmountToSell) {
