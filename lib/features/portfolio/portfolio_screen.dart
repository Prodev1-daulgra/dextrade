      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Your asset allocation overview',
                        ...
                        children: [
                          ...
                          Expanded(
                            child: _InfoBlock(
                              ...
                              pnl >= 0 ? DexColors.success : DexColors.error,
                            ),
                          ),
                        ],
                      ),
            ...
            portfolioAsync.when(
              data: (portfolioList) {
                return cryptosAsync.when(
                  data: (cryptos) {
                    if (portfolioList.isEmpty) {
                      return const EmptyStateWidget(
                        ...
                        subtitle:
                            'Initialize a node in the Trade terminal to allocate assets to your portfolio.',
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              Text(
                                                '${p.amount.toStringAsFixed(4)} ${p.cryptoSymbol}',
                                                style: DexTypography.caption,
                                              ),
                                              const SizedBox(width: 8),
                                              Text(
                                                'Avg \$${p.avgBuyPrice.toStringAsFixed(2)}',
                                                style: DexTypography.caption
                                                    .copyWith(
                                                      color:
                                                          DexColors.textMuted,
                  ...
                  error: (_, __) => const Text(
                    ...
                    style: TextStyle(color: DexColors.error),
                  ),
                );
              },
              loading: () => Column(
              ...
              error: (_, __) => const Text(
                'Failed to load portfolio nodes',
                style: TextStyle(color: DexColors.error),
              ),
            ),
          ],
